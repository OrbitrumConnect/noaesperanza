...
*Relatório gerado em: ${new Date().toLocaleString('pt-BR')}*
  ...
  // Função para tocar áudio da NOA (versão antiga - mantida para compatibilidade)
  const playNoaAudio = async (text: string) => {
    try {
      console.log('🎵 Tentando tocar áudio:', { userInteracted, audioPlaying, text: text.substring(0, 50) + '...' })
