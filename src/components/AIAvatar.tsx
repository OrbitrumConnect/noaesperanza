...
const AIAvatar = ({ isListening, onToggleListening, specialty, addNotification }: AIAvatarProps) => {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-30 flex flex-col items-center">
      {/* Anel de Escuta */}
      {isListening && (
      ...
      {/* Avatar Principal */}
      <div 
        className="ai-avatar cursor-pointer hover:scale-105 transition-transform relative z-20"
        onClick={handleClick}
      >
        {/* Fundo do Avatar */}
