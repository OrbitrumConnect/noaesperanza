...
export default function PlanEditModal({ isOpen, onClose, planData, onSave }: PlanEditModalProps) {
  ...
  const handleSave = async () => {
    try {
      ...
      console.log('Salvando plano:', editedPlan);
      ...
      toast({
        ...
        description: "Todas as alterações do plano alimentar foram salvas com sucesso.",
        variant: "default"
      });
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <DialogTitle className="flex items-center gap-2">
            ...
            Editar Plano MEV - {editedPlan.plan_name}
          </DialogTitle>
          <p className="text-sm text-muted-foreground">
            Personalize o plano alimentar e práticas de bem-estar para este paciente
          </p>
        </DialogHeader>
