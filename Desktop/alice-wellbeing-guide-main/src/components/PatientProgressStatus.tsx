        ...
        <CardContent className="space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {!hasCompletedPostConsultation && currentStep === 3 && (
              <Button size="sm" onClick={onStartPostConsultation} className="text-xs">
                Iniciar
              </Button>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3">
            ...
            <Button 
              ...
              onClick={() => {
                ...
                link.href = '/meu-plano-alimentar.pdf';
                link.download = 'meu-plano-alimentar.pdf';
                link.click();
              }}
            >
            ...
            <Button 
              ...
              className="h-auto py-2 sm:py-3 flex flex-col gap-1"
              onClick={() => {
                // Simular abertura do analisador de prato
                alert('Analisador de prato será aberto! (Em desenvolvimento)');
              }}
            >
