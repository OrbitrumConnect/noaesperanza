        ...
        <div className={`relative z-10 max-w-4xl mx-auto ${isMobile ? 'p-1 h-full overflow-y-auto' : 'p-6'}`}>
          ...
          <div className={`arena-card-digital-started text-center ${isMobile ? 'p-2' : 'p-4'}`}>
            ...
            <div className={`arena-card border-epic/30 ${isMobile ? 'p-1.5 mb-2' : 'p-3 mb-3'}`}>
              <h3 className={`font-semibold text-epic ${isMobile ? 'text-xs mb-0.5' : 'text-sm mb-1'}`}>📊 Limite Diário</h3>
    ...
    return (
     ...
     console.log('🔍 DEBUG Digital.tsx:', {
      ...
      <ParticleBackground />
                                                                                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                               <div className={`relative z-10 max-w-4xl mx-auto p-1 h-screen overflow-hidden w-full md:p-6 ${isMobile ? '' : 'scale-78 -mt-1'}`}>
        ...
        <div className="relative mb-1 mx-1 md:mb-4">
          <div className="relative w-full flex items-center justify-between h-20 mb-1 md:h-32 md:mb-4">
           ...
           {laserShots.map((shot, index) => {
             ...
             return (
               ...
               >
                 {laserSize}
                                    ...
                                    {/* Pergunta */}
                                       <div className={`arena-card-epic backdrop-blur-sm bg-cyan-500/10 border border-cyan-500 ${isMobile ? 'p-3 mb-4 mx-2 w-full' : 'p-4 mb-4 border-2 glow-epic max-w-2xl mx-auto scale-90 -mt-15'}`}>
             ...
             <h2 className={`font-montserrat font-bold text-center text-foreground ${isMobile ? 'text-xs mb-0.5' : 'text-lg mb-6'}`}>
               {question.question}
             </h2>
                  ...
                  <button
                    ...
                    disabled={gamePhase !== 'question'}
                                         className={`rounded border transition-all text-left backdrop-blur-sm ${isMobile ? 'p-0.5 text-xs' : 'p-2.5 border-2 rounded-lg'} relative z-50 ${
                       gamePhase === 'question' 
                  ...
                  >
                   <div className={`flex items-center ${isMobile ? 'space-x-1' : 'space-x-2'}`}>
                      <div className={`rounded-full flex items-center justify-center font-bold ${isMobile ? 'w-4 h-4 text-xs' : 'w-8 h-8 text-base'} ${
                     ...
                     <span className={`font-semibold ${isMobile ? 'text-xs' : 'text-base'}`}>{option}</span>
                   </div>
                 </button>
               ))}
             </div>
                     ...
                     {/* Explicação - FORA do card principal */}
                       {showExplanation && (
              <div className={`mt-1 mx-auto w-full arena-card backdrop-blur-sm bg-background-soft/80 ${isMobile ? 'p-3' : 'p-3'} rounded-lg border border-card-border ${isMobile ? 'max-w-full' : 'max-w-2xl'} ${isMobile ? '' : 'scale-90 -mt-5'}`}>
               <h4 className={`font-semibold text-cyan-400 ${isMobile ? 'mb-1.5 text-xs' : 'mb-2 text-sm'} flex items-center`}>
                 <div className={`${isMobile ? 'w-3.5 h-3.5' : 'w-5 h-5'} bg-cyan-500 rounded-full flex items-center justify-center ${isMobile ? 'mr-1.5' : 'mr-2'}`}>
                   <span className="text-xs text-cyan-900">!</span>
                 </div>
                 Explicação:
               </h4>
               <p className={`text-muted-foreground ${isMobile ? 'text-xs' : 'text-sm'}`}>{question.explanation}</p>
               {question.source && (
                 <div className={`${isMobile ? 'mt-1.5 pt-1.5' : 'mt-2 pt-2'} border-t border-card-border/30`}>
