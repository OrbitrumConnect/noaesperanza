...
import PvPDev from "./pages/PvPDev";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/pvp-dev" element={<ProtectedRoute><PvPDev /></ProtectedRoute>} />
        <Route path="/arena/battle/:roomId" element={<ProtectedRoute><PvPBattle /></ProtectedRoute>} />
