...
export const PLAN_CONFIGS: Record<PlanType, PlanConfig> = {
  premium: {
    ...
    creditsReceived: 7, // 7 créditos = 1 PvP inicial (SUSTENTÁVEL!)
    monthType: 'month1',
    isAdultOnly: true, // Apenas maiores de 18 anos

    trainingRewards: {
      'egito-antigo': { base: 0.65, victory: 0.85, excellent: 1.05 },
      'mesopotamia': { base: 0.65, victory: 0.85, excellent: 1.05 },
      'medieval': { base: 0.65, victory: 0.85, excellent: 1.05 },
      'digital': { base: 0.65, victory: 0.85, excellent: 1.05 },
      'labirinto': { base: 0.65, victory: 0.85, excellent: 1.05 }
    },
