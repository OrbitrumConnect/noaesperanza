  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-40 p-2 sm:p-4 transition-all duration-300" style={{ transform: 'scale(1.06)' }}>
        <nav className="flex justify-between items-center glassmorphism rounded-full px-3 sm:px-6 py-2 sm:py-3 max-w-6xl mx-auto backdrop-blur-sm bg-black/30 sm:bg-black/40">
          ...
          <div className="hidden sm:flex items-center space-x-3 md:space-x-6">
            <Link href="/" className={`hover:text-[var(--neon-cyan)] transition-colors flex items-center space-x-1 text-sm ${location === '/' ? 'text-[var(--neon-cyan)]' : ''}`}>
              <Home className="h-4 w-4" />
              <span>Orbit</span>
            </Link>
            <Link href="/teams" className={`hover:text-[var(--neon-cyan)] transition-colors flex items-center space-x-1 text-sm ${location === '/teams' ? 'text-[var(--neon-cyan)]' : ''}`}>
            ...
            {isAuthenticated && (
              <Link 
                ...
                className="hover:text-[var(--neon-cyan)] transition-colors flex items-center space-x-1 text-sm"
              >
            ...
            {isAuthenticated && (
              <Link 
                ...
                className={`hover:text-[var(--neon-cyan)] transition-colors flex items-center space-x-1 text-sm ${location.startsWith('/dashboard') ? 'text-[var(--neon-cyan)]' : ''}`}
              >
                <UserIcon className="h-4 w-4" />
                <span>Dashboard</span>
              </Link>
            )}
            <Link href="/admin" className={`hover:text-[var(--neon-cyan)] transition-colors flex items-center space-x-1 text-sm ${location === '/admin' ? 'text-[var(--neon-cyan)]' : ''}`}>
          ...
          >
            ...
            >
              <div className="p-2 space-y-1">
                ...
                <Link 
                  href="/" 
                  className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-[var(--neon-cyan)]/10 transition-all duration-300 ${location === '/' ? 'bg-[var(--neon-cyan)]/20 text-[var(--neon-cyan)]' : 'hover:text-[var(--neon-cyan)]'}`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <Home className="h-4 w-4" />
                ...
                <Link 
                  href="/teams" 
                  className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-[var(--neon-cyan)]/10 transition-all duration-300 ${location === '/teams' ? 'bg-[var(--neon-cyan)]/20 text-[var(--neon-cyan)]' : 'hover:text-[var(--neon-cyan)]'}`}
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <Users className="h-4 w-4" />
                ...
                {isAuthenticated && (
                  <Link 
                    ...
                    className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-[var(--neon-cyan)]/10 transition-all duration-300 ${location.includes('/dashboard') ? 'bg-[var(--neon-cyan)]/20 text-[var(--neon-cyan)]' : 'hover:text-[var(--neon-cyan)]'}`}
                    onClick={() => {
                ...
                <Link 
                  href="/cadastro" 
                  className="flex items-center space-x-2 p-2 rounded-lg hover:bg-blue-500/10 hover:text-blue-400 transition-all duration-300"
                  onClick={() => setMobileMenuOpen(false)}
                >
