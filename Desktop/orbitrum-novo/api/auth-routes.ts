...
import { registerUser, loginUser, verifyEmail, resendConfirmationEmail, loginWithGoogle } from "./supabase-auth";
// import { initializeSupabase } from "./supabase-auth"; // DESABILITADO
...
export function setupAuthRoutes(app: Express) {
  // Supabase já foi inicializado no index.ts
  console.log('🔐 Rotas de auth configuradas - Supabase já inicializado');
